"""
Django settings for dije project.
...
SECRET_KEY = 'django-insecure-8)0=5@zp)=s(e%xw4+e93s6pm*c^==l7t-ch4g&2i^-vso7eat'
...
WSGI_APPLICATION = 'dije.wsgi.application'
